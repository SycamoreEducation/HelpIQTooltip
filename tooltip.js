document.write('<style type="text/css">.tooltip-wrap{position:absolute;display:none;width:300px;left:0;top:0;z-index:20000;overflow:hidden}.tooltip .tooltip-close{width:16px;height:16px;background:url(http://www.helpdocsonline.com/tooltips/close.png) 0 0 no-repeat;cursor:pointer;text-indent:-9999em;overflow:hidden;display:block;font-size:0;float:right;margin:2px 3px 2px 4px;}.tooltip-loading{background:url(http://www.helpdocsonline.com/tooltips/loading.gif) 3px 5px no-repeat;padding:6px 6px 3px 25px;height:17px;border-style:solid;border-width:0;width:50px;font:12px Arial,Helvetica,sans-serif;}.tooltip{opacity:1;}</style>');
jQuery.extend({
    helpiqTip: function () {
        var b = {
            fadeEffect: [true, 150],
